...
def bezierparameterize(b0, b1, b2, b3):
    bx0, by0 = b0
    bx1, by1 = b1
    bx2, by2 = b2
    bx3, by3 = b3
...
def linebezierintersect(l1, l2, b0, b1, b2, b3):
    lx1, ly1 = l1
    lx2, ly2 = l2
    bx0, by0 = b0
    bx1, by1 = b1
    ...
    for i in roots:
        ...
        if type(i) is not complex and 0 <= i <= 1:
            retval.append(bezierpointatt(
                ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)), i))
    return retval


def bezierpointatt(blah, t):
    b0, b1, b2, b3 = blah
...
def bezierlengthSimpson(blah, tolerance=0.001):
    b0, b1, b2, b3 = blah
    ...
    ax, ay, bx, by, cx, cy, x0, y0 = bezierparameterize(
        ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)))
    balfax, balfbx, balfcx, balfay, balfby, balfcy = 3 * \
        ax, 2 * bx, cx, 3 * ay, 2 * by, cy
    return Simpson(balf, 0.0, 1.0, 4096, tolerance)


def beziertatlength(blah, l=0.5, tolerance=0.001):
    b0, b1, b2, b3 = blah
