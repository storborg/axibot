...
# Page size values typically do not need to be changed. They primarily affect
# viewpoint and centering.
# Measured in page pixelssteps.  Default printable area for AxiDraw is 300
# x 218 mm

N_PAGE_HEIGHT = 8.58     # Default page height in inches
# 218 mm = about 8.58 inches

N_PAGE_WIDTH = 11.81      # Default page width in inches
# 300 mm = about 11.81 inches


# Machine resolution: Used in converting drawing size to motor steps.
# DPI ("dots per inch") @ 16X microstepping.  Standard value: 2032, or 80
# steps per mm.
DPI_16X = 2032

Speed_Scale = 24950  # Maximum (110%) speed, in steps per second.
# Note that 25 kHz is the absolute maximum speed (steps per second) for
# the EBB.
...
# Short-move pen-up distance threshold, below which we use the faster
